...
namespace ApiTestFramework.Tests
{
    public class FactsTests
    {
        ...
        {
            var listOfFactIds = new[] { "5b7a07a32048fd0014e9d8b2", "5b12d729cf4b960d5eb02eba",
                                        "5b7a06b22048fd0014e9d8a2", "5b7a057c2048fd0014e9d89a" };
            var randomFactIndex = _random.Next(0, listOfFactIds.Length);

            var response = await _factsApi.GetFactAsync(listOfFactIds[randomFactIndex]);
